...
export default function StomachStopwatch({ endTime, stationName, runningStation, setRunningStation, procedureStarted }) {
  ...
  else if(runningStation !== null && runningStation !== stationName && stationName !== 'FNA') {
    isDisabled = true;
  }
